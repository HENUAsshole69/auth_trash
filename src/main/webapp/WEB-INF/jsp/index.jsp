    ...
    <form class="layui-form" id="AntiqueForm">
        <div class="layui-form-item" style="margin-bottom: 25px;">
            ...
            <div class="layui-input-block">
                <input value="" type="text" name="antique_number" required  lay-verify="required" autocomplete="off" class="layui-input antique_number" style="width: 250px;margin-top: 30px;">
            </div>
        </div>
        <div class="layui-form-item" style="margin-bottom: 25px;">
            <label class="layui-form-label">*名称</label>
            <div class="layui-input-block">
                <input value="" type="text" name="antique_name" required  lay-verify="required" autocomplete="off" class="layui-input antique_name" style="width: 250px;margin-top: 30px;">
            </div>
        </div>
        <div class="layui-form-item" style="margin-bottom: 25px;">
        ...
        <div class="layui-form-item" style="margin-bottom: 25px;">
            ...
            <div class="layui-input-block">
                <input value="" type="text" name="antique_time" required  lay-verify="required" autocomplete="off" class="layui-input antique_time" style="width: 250px;">
            </div>
        </div>
         <div class="layui-form-item" style="margin-bottom: 25px;">
            <label class="layui-form-label" style="width: 100px;">完整程度</label>
            <div class="layui-input-block">
                <input value="" type="text" name="antique_intact" required  lay-verify="required" autocomplete="off" class="layui-input antique_intact" style="width: 250px;">
            </div>
        </div>
        <div class="layui-form-item" style="margin-bottom: 25px;">
            <label class="layui-form-label" style="width: 100px;">鉴定诉求</label>
            <div class="layui-input-block">
                <input value="" type="text" name="antique_authenticate" required  lay-verify="required" autocomplete="off" class="layui-input antique_authenticate" style="width: 250px;">
            </div>
        </div>
        <div class="layui-form-item" style="margin-bottom: 25px;">
            <label class="layui-form-label" style="width: 100px;">来源信息</label>
            <div class="layui-input-block">
                <input value="" type="text" name="antique_info" required  lay-verify="required" autocomplete="off" class="layui-input antique_info" style="width: 250px;">
            </div>
        </div>
        <div class="layui-form-item layui-form-text" style="position: relative;">
            <label class="layui-form-label">规格</label>
            <div class="layui-input-block">
                <textarea type="text" name="antique_form" placeholder="请输入规格" class="layui-textarea antique_form"></textarea>
            </div>
        </div>
        <div class="layui-form-item layui-form-text" style="position: relative;">
            <label class="layui-form-label">描述</label>
            <div class="layui-input-block">
                <textarea type="text" name="antique_details" placeholder="请输入文物描述" class="layui-textarea antique_details"></textarea>
            </div>
        </div>
    ...
    <div class="layui-tab-content" >
        ...
        <div class="layui-tab-item layui-show" style="height: 650px;">
            <div class="personInfoInput">
                <form class="layui-form" id="individual" action="${pageContext.request.contextPath}/antique/newAntique/individual" method="post">
                    <div class="layui-form-item" style="margin-bottom: 25px;">
        ...
        <div class="layui-tab-item">
            <div class="personInfoInput">
                <form class="layui-form" id="company" action="${pageContext.request.contextPath}/antique/newAntique/company" method="post">
                    <div class="layui-form-item" style="margin-bottom: 25px;">
                    ...
                    <div class="layui-form-item" style="margin-bottom: 25px;">
                        ...
                        <div class="layui-input-block">
                            <input value="" type="text" name="applicant_buscode" required  lay-verify="required" autocomplete="off" class="layui-input applicant_buscode" style="width: 250px;margin-top: 30px;">
                        </div>
                    </div>
                    <div class="layui-form-item" style="margin-bottom: 25px;">
                        <label class="layui-form-label" style="width: 100px;">注册地址</label>
                        <div class="layui-input-block">
                            <input value="" type="text" name="applicant_loginadress" required  lay-verify="required" autocomplete="off" class="layui-input applicant_loginadress" style="width: 250px;">
                        </div>
                    </div>
                    <div class="layui-form-item" style="margin-bottom: 25px;">
                        <label class="layui-form-label" style="width: 100px;">官方代表人</label>
                        <div class="layui-input-block">
                            <input value="" type="text" name="applicant_represent" required  lay-verify="required" autocomplete="off" class="layui-input applicant_represent" style="width: 250px;">
                        </div>
                    </div>
                    <div class="layui-form-item" style="margin-bottom: 25px;">
                        <label class="layui-form-label" style="width: 100px;">法人职务</label>
                        <div class="layui-input-block">
                            <input value="" type="text" name="applicant_legal" required  lay-verify="required" autocomplete="off" class="layui-input applicant_legal" style="width: 250px;">
                        </div>
                    </div>
                    <div class="layui-form-item" style="margin-bottom: 25px;">
                        <label class="layui-form-label" style="width: 100px;">注册资本</label>
                        <div class="layui-input-block">
                            <input value="" type="text" name="applicant_capital" required  lay-verify="required" autocomplete="off" class="layui-input applicant_capital" style="width: 250px;">
                        </div>
                    </div>
                    <div class="layui-form-item" style="margin-bottom: 25px;">
                        <label class="layui-form-label" style="width: 100px;">联络人</label>
                        <div class="layui-input-block">
                            <input value="" type="text" name="applicant_reperson" required  lay-verify="required" autocomplete="off" class="layui-input applicant_reperson" style="width: 250px;">
                        </div>
                    </div>
                    <div class="layui-form-item" style="margin-bottom: 25px;">
                        <label class="layui-form-label" style="width: 100px;">联系人职务</label>
                        <div class="layui-input-block">
                            <input value="" type="text" name="applicant_rejob" required  lay-verify="required" autocomplete="off" class="layui-input applicant_rejob" style="width: 250px;">
                        </div>
                    </div>
                    <div class="layui-form-item" style="margin-bottom: 25px;">
	...
	<div class="layui-container"> 
		<div >
			<ul class="layui-nav" lay-filter="">
			  ...
			  <li class="layui-nav-item" style="position: relative; left: 72%;">
			...
			<!-- 侧边导航: <ul class="layui-nav layui-nav-tree layui-nav-side"> -->
			  ...
			  <li class="layui-nav-item layui-nav-itemed">
			    ...
			    <dl class="layui-nav-child">
                    <dd>    <a onclick="newInfo()">新建 <i class="layui-icon" style="font-size:20px;margin-left: 100px;">&#xe654;</i></a></dd>
			      <dd><a href="${pageContext.request.contextPath}/index/1">浏览 <i class="layui-icon" style="font-size:20px;margin-left: 100px;">&#xe705;</i></a></dd>
			      <dd><a href="${pageContext.request.contextPath}/antique/audit/1">文物复核 <i class="layui-icon" style="font-size:20px;margin-left: 72px;">&#xe6b2;</i></a></dd>
			      <dd>    <a href="${pageContext.request.contextPath}/antique/audit3/1">初步鉴定 <i class="layui-icon" style="font-size:20px;margin-left: 72px;">&#xe657;</i></a></dd>
			      <dd>    <a href="${pageContext.request.contextPath}/antique/audit4/1;">多维鉴定 <i class="layui-icon" style="font-size:20px;margin-left: 70px;">&#xe656;</i></a></dd>
                    <dd>    <a href="${pageContext.request.contextPath}/antique/audit5/1;">位点录入 <i class="layui-icon" style="font-size:20px;margin-left: 70px;">&#xe857;</i></a></dd>
			      <dd>    <a href="${pageContext.request.contextPath}/antique/audit6/1;">证书信息 <i class="layui-icon" style="font-size:20px;margin-left: 70px;">&#xe663;</i></a></dd>
			      <dd>    <a href="${pageContext.request.contextPath}/antique/audit7/1;">业务录入 <i class="layui-icon" style="font-size:20px;margin-left: 70px;">&#xe67d;</i></a>   </dd>
			    </dl>
			  </li>
			  <li class="layui-nav-item layui-nav-itemed">
			    <a href="javascript:;"><i class="layui-icon" style="font-size:20px;margin-right: 10px;">&#xe66f;</i>管理</a>
			    <dl class="layui-nav-child">
                    <shiro:hasRole name="超级管理员">
			      <dd><a href="${pageContext.request.contextPath}/antique/user/1">用户管理 <i class="layui-icon" style="font-size:20px;margin-left: 70px;">&#xe612;</i></a></dd>
                    </shiro:hasRole>
                  <dd><a href="">日志 <i class="layui-icon" style="font-size:20px;margin-left: 100px;">&#xe621;</i></a></dd>
			    </dl>
			  </li>
			</ul>
	  	</div>
